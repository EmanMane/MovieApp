...
fun getFavoriteMovies(): List<Movie> {
    return listOf(
        ...
        Movie(3,"The Whale",
            ...
            "drama", null, listOf("Brendan Fraser", "Elsa Pataky", "Julia Rehwald"), listOf("Free Willy", "Dolphin Tale", "Blackfish")),
        Movie(4,"Smile",
            ...
            "horror", null, listOf("Nathan Stewart-Jarrett", "Sophie Kennedy Clark", "Gbemisola Ikumelo"), listOf("Little Miss Sunshine", "Juno", "Eternal Sunshine of the Spotless Mind")),
        Movie(5,"Interstellar",
            "A team of explorers travel through a wormhole in space in an attempt to ensure humanity's survival.",
            "16.02.2021.","https://www.imdb.com/title/tt0816692/",
            "scifi", null, listOf("Matthew McConaughey", "Anne Hathaway", "Jessica Chastain"), listOf("Gravity", "The Martian", "Inception")),
        Movie(6,"The Godfather",
            "The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son.",
            "16.02.2021.","https://www.imdb.com/title/tt0068646/",
            "drama", null, listOf("Marlon Brando", "Al Pacino", "James Caan"), listOf("The Godfather: Part II", "Goodfellas", "The Departed")),
        Movie(7,"Get Out",
            "A young African-American visits his white girlfriend's parents for the weekend, where his simmering uneasiness about their reception of him eventually reaches a boiling point.",
            "16.02.2021.","https://www.imdb.com/title/tt5052448/",
            "horror", null, listOf("Daniel Kaluuya", "Allison Williams", "Bradley Whitford"), listOf("Us", "Hereditary", "The Babadook")),
        Movie(8,"The Lord of the Rings: The Fellowship of the Ring",
            ...
            "fantasy", null, listOf("Elijah Wood", "Ian McKellen", "Orlando Bloom"), listOf("The Lord of the Rings: The Two Towers", "The Lord of the Rings: The Return of the King", "The Hobbit: An Unexpected Journey")),
        Movie(9, "Jurassic Park",
            "A pragmatic paleontologist visiting an almost complete theme park is tasked with protecting a couple of kids after a power failure causes the park's cloned dinosaurs to run loose.",
            "16.02.2021", "https://www.imdb.com/title/tt0107290/",
            "adventure", null, listOf("Sam Neill", "Laura Dern", "Jeff Goldblum"), listOf("Jurassic World", "King Kong", "Avatar")),
        Movie(10, "The Matrix",
            "A computer hacker learns from mysterious rebels about the true nature of his reality and his role in the war against its controllers.",
            "16.02.2021", "https://www.imdb.com/title/tt0133093/",
            "scifi", null, listOf("Keanu Reeves", "Laurence Fishburne", "Carrie-Anne Moss"), listOf("Inception", "Blade Runner", "The Terminator")),
        Movie(11, "The Silence of the Lambs",
            "A young F.B.I. cadet must receive the help of an incarcerated and manipulative cannibal killer to help catch another serial killer, a madman who skins his victims.",
            "16.02.2021", "https://www.imdb.com/title/tt0102926/",
            "drama", null, listOf("Jodie Foster", "Anthony Hopkins", "Scott Glenn"), listOf("Se7en", "Fight Club", "Memento")),
        Movie(12, "Goodfellas",
            "The story of Henry Hill and his life in the mob, covering his relationship with his wife Karen Hill and his mob partners Jimmy Conway and Tommy DeVito in the Italian-American crime syndicate.",
            "16.02.2021", "https://www.imdb.com/title/tt0099685/",
            "drama", null, listOf("Robert De Niro", "Ray Liotta", "Joe Pesci"), listOf("The Godfather", "The Departed", "Scarface")),
        Movie(13, "The Lion King",
            ...
            "adventure", null, listOf("Matthew Broderick", "Jeremy Irons", "James Earl Jones"), listOf("Beauty and the Beast", "Aladdin", "Mulan")),
        Movie(14, "The Social Network",
            ...
            "drama", null, listOf("Jesse Eisenberg", "Andrew Garfield", "Justin Timberlake"), listOf("Steve Jobs", "The Imitation Game", "The Founder")),

        Movie(15, "Inception",
            "A thief who steals corporate secrets through the use of dream-sharing technology is given the inverse task of planting an idea into the mind of a CEO.",
            "16.02.2021", "https://www.imdb.com/title/tt1375666/",
            "drama", null, listOf("Leonardo DiCaprio", "Joseph Gordon-Levitt", "Ellen Page"), listOf("Interstellar", "The Prestige", "The Dark Knight")),

        Movie(16, "The Shawshank Redemption",
            "Two imprisoned men bond over a number of years, finding solace and eventual redemption through acts of common decency.",
            "16.02.2021", "https://www.imdb.com/title/tt0111161/",
            "drama", null, listOf("Tim Robbins", "Morgan Freeman", "Bob Gunton"),listOf("The Green Mile", "Forrest Gump", "Schindler's List")),
...
fun getRecentMovies(): List<Movie> {
    return listOf(
        Movie(1,"The Dictator",
            ...
            "comedy", null, listOf("Sacha Baron Cohen", "Anna Faris", "Ben Kingsley"), listOf("Borat", "Brüno", "The Interview")),

        Movie(2,"Shrek",
            "A mean lord exiles fairytale creatures to the swamp of a grumpy ogre, who must go on a quest and rescue a princess for the lord in order to get his land back.",
            "16.02.2021.","https://www.imdb.com/title/tt0126029/?ref_=nv_sr_srsg_0",
            "fantasy", null, listOf("Mike Myers", "Eddie Murphy", "Cameron Diaz"), listOf("Toy Story", "The Lion King", "Finding Nemo")),
        ...
        Movie(3,"Back to the Future Part III",
            ...
            "western", null, listOf("Michael J. Fox", "Christopher Lloyd", "Mary Steenburgen"), listOf("The Good, the Bad and the Ugly", "Unforgiven", "Once Upon a Time in the West")),
        ...
        Movie(4,"Puss in Boots: The Last Wish",
            ...
            "adventure", null, listOf("Antonio Banderas", "Salma Hayek", "Zach Galifianakis"), listOf("The Adventures of Tintin", "How to Train Your Dragon", "Kung Fu Panda"))
    )
}
