...
object MovieRepository {
    ...
    private const val tmdb_api_key : String = "2ab3e9674ead894beed2773e7be60d3b"
            ...
            try {
                ...
                (url.openConnection() as? HttpURLConnection)?.run {
                    ...
                    for (i in 0 until results.length()) {
                        ...
                        movies.add(Movie(id.toLong(), title, overview, releaseDate, null, null, posterPath, listOf(), listOf()))
                        if (i == 15) break
                    }
                }
                //[email protected]
